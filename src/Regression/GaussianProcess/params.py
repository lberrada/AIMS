...
def get_params(use_kernels=None,
    ...
    aux_kernel_dict["exponential_quadratic"][
        "names"] = ["eq_sigma_f", "eq_scale"]
    aux_kernel_dict["exponential_quadratic"]["means"] = [0.5, 5.]
    aux_kernel_dict["exponential_quadratic"]["stds"] = [0.5, 3]
    aux_kernel_dict["exponential_quadratic"]["bounds"] = [
        (zero_bound, None), (zero_bound, None)]
    ...
    aux_kernel_dict["periodic"]["bounds"] = [
        (zero_bound, None), (zero_bound, None)]
    ...
    aux_kernel_dict["rational_quadratic"][
        "names"] = ["rq_sigma_f", "rq_scale", "rq_nu"]
    aux_kernel_dict["rational_quadratic"]["means"] = [1., 5., 2.]
    aux_kernel_dict["rational_quadratic"]["stds"] = [0.5, 3, 0.5]
    aux_kernel_dict["rational_quadratic"]["bounds"] = [
        (zero_bound, None), (zero_bound, None), (zero_bound, None)]
    ...
    aux_mean_dict["quadratic"]["bounds"] = [
